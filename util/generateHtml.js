...
const generateTeam = team => {
    ...
    const generateManager = manager => {
        return `
    <div class="card employee-card mx-1 mt-1">
    ...
    <div class="card employee-card mx-1 mt-1">
        <div class="card-header bg-success">
            ...
            <h3 class="card-title text-center"><i class="fas fa-user-graduate mr-2"></i>${intern.getRole()}</h3>
        </div>
        <div class="card-body">
            <ul class="list-group">
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="team-area col-12 d-flex justify-content-center" style="flex-wrap: wrap;">
                ${generateTeam(team)}
            </div>
        </div>
    </div>
